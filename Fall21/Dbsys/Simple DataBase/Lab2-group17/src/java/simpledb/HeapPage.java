...
public class HeapPage implements Page {
    ...
    */
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        //If tuple not null get the Tuple number
        int tupleNum = t.getRecordId().getTupleNumber();
        // get the heappageId where it's stored
        HeapPageId heapPageId = (HeapPageId) t.getRecordId().getPageId();
       //Check if the Tuple belong to this heappage and not empty
        if (!(isSlotUsed(tupleNum)&&heapPageId.equals(pid)) ) {
            throw new DbException("this tuple is not on this page, or tuple slot is already empty");
        }
        //If the tuple is in this heappage and not empty, set it to null
        tuples[tupleNum]=null;
        //Mark it's slot as unused
    ...
    public void insertTuple(Tuple t) throws DbException {
    	...
    	if(i == numSlots)
    		throw new DbException("Page is full.Cannot add tuple any more.");
    ...
    private void markSlotUsed(int i, boolean value) {
        ...
        // not necessary for lab1
        if(i >= numSlots){
    		System.out.println("i beyond numSlots.");
        	return;
    	}
    	int byteN = i/8; 
    	int bitN = i % 8;  	
  ...
  public Iterator<Tuple> iterator() {
    ...
    TupleIterator tpItr = new TupleIterator(td, tplist);
    tpItr.open();
    return tpItr.i;
  }
